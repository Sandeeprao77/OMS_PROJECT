...
export class TeamleadService {
  ...
  postteamleadregister(data:any):Observable<any>{
    return this.http.post("http://localhost:3003/teamlead/teamleadregister",data)
  }
  ...
  updateteamlead(id:String,data:any):Observable<any>{
    return this.http.put(`http://localhost:3003/teamlead/updateteamlead/${id}`,data)
  }
  deleteteamlead(id:String):Observable<any>{
    return this.http.delete(`http://localhost:3003/teamlead/deleteteamlead/${id}`)
  }
  tasklist():Observable<any>{
    return this.http.get("http://localhost:3003/teamlead/gettask")
  }
  updatetask(id:String,data:any):Observable<any>{
    return this.http.put(`http://localhost:3003/teamlead/updatetask/${id}`,data)
  }
